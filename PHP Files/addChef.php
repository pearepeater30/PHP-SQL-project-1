...
//Insert dynamic PHP data from a web form into Worker and Chef Tables
...
$query .= "INSERT INTO Chef(WorkerID, ChefID, Specialty)
VALUES ('$_POST[workerID]','$_POST[chefID]', '$_POST[specialty]');";
